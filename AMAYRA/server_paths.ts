 ...
 * packaged Electron app launches the backend it sets AMAYRA_DATA_DIR to a
 * writable folder under %APPDATA%\AMAYRA, because the install directory
...
export const DATA_DIR: string = process.env.AMAYRA_DATA_DIR || process.cwd();
